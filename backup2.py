...
# a simple constructor to build basic rectangular platforms from square 100 X 100 sprites
...
# arbiter class for storing global variables and computations, like keeping track of lives and coordinates etc.
...
# the mouse controlled reticle for aiming
...
# controlling movement based on keyboard and mouse input
...
# initialising the sprites and putting them in groups

...
groundtiles = [
    pygame.image.load("groundlefttop.png"),
    pygame.image.load("groundmidtop.png"),
    pygame.image.load("groundbotleft.png"),
    pygame.image.load("groundbotmid.png"),
    pygame.transform.flip((pygame.image.load("groundlefttop.png")), True, False),
    pygame.transform.flip((pygame.image.load("groundbotleft.png")), True, False)
]
...
Lizlegsaireverse = [
    pygame.transform.flip((pygame.image.load("jump1.png")), True, False),
    pygame.transform.flip((pygame.image.load("jump2.png")), True, False)
]
Lizlegsrun = [
...
Liztorsopix = [
    ...
    pygame.image.load("torsosmall15.png"),
]
Liztorsoreverse = []
